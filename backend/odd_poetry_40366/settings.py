"""
Django settings for odd_poetry_40366 project.
...
ROOT_URLCONF = 'odd_poetry_40366.urls'
...
WSGI_APPLICATION = 'odd_poetry_40366.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "odd_poetry_40366 API",
    "DESCRIPTION": "API documentation for odd_poetry_40366 App",
    "VERSION": "v1",
}
